...
over 52 weeks. (Assuning vacation is unpaid)  Then asks how much money
...
# determine if number of years is even or odd
                num = round(years_to_save,2) % 2
                if num == 0:
                    print ' '
                    print 'If the number of years is ' ,years_to_save, ' then it is an even number'
                else:
                    print 'If the number of years is ' ,years_to_save, 'is an odd number'
